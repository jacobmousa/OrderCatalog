...
public record OrderResponse(Guid Id, string CustomerId, string Status, decimal TotalAmount, DateTime CreatedUtc, DateTime UpdatedUtc, IReadOnlyList<OrderItemResponse> Items)
